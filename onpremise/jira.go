...
func newResponse(r *http.Response, v interface{}) *Response { _ = "STUB: not implemented"; return nil }
...
func (r *Response) populatePageValues(v interface{}) { _ = "STUB: not implemented"; return }
